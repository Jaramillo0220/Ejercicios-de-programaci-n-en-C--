...
int main(int argc, char *argv[])
{
    do
    {
        ...
        cout << "\n2. Los datos se rellenaran aleatoriamente ";
        cout << "\nIngresa la opcion: ";
        cin >> x;
        switch (x)
        {
        case 1:
            cont = 0;
            cout << "\nIngresa la cantidad de columnas (vertical): ";
            cin >> b2;
            cout << "Ingresa la cantidad de filas (horizontal): ";
            cin >> b1;
            cout << "\n";
            for (i = 0; i < b2; i++)
            {
                for (j = 0; j < b1; j++)
                {
                    cout << " Ingresa los datos de la matriz posicion (" << i << "," << j << "): ";
                    cin >> a1;
                    a[i][j] = a1;
                }
                cout << "\n";
        ...
        case 2:
            ...
            break;
        default:
            cout << "\n\nTienes que ingresar una opcion valida";
            break;
        }
        cout << "\n\nQuieres volver a ingresar otros numeros? (y/n): ";
        cin >> resp;
    } while (resp == 'Y' || resp == 'y');
    return 0;
}
